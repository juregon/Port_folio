		...
		<div class="joinform">
			...
			<form action="joinMember.mvc"name="joinForm"">
				...
				<div class="row">
					...
					<div class="col-md-5">
						<input type="password" id="pass1" name="pass" placeholder="8~16 characters" maxlength="16">
					</div>
				</div>
				<div class="row">
					<div class="col-md-offset-2 col-md-3">
					...
					<img src="img/check_ok.png" width="20px" height="20px" id="passcheck">
					</div>
				</div>
				<div class="row">
					<div class="col-md-offset-2 col-md-3">
				...
				<div class="row">
					...
					<fieldset>
						<legend>CHECK</legend>
						<input type="checkbox" name="al" value="대두">대두
						<input type="checkbox" name="al" value="땅콩">땅콩
						<input type="checkbox" name="al" value="우유">우유
						<input type="checkbox" name="al" value="게">게
						<input type="checkbox" name="al" value="새우">새우
						<input type="checkbox" name="al" value="참치">참치
						<input type="checkbox" name="al" value="연어">연어
						<input type="checkbox" name="al" value="쑥">쑥
						<input type="checkbox" name="al" value="소고기">소고기
						<input type="checkbox" name="al" value="닭고기">닭고기
						<input type="checkbox" name="al" value="돼지고기">돼지고기
						<input type="checkbox" name="al" value="복숭아">복숭아
						<input type="checkbox" name="al" value="민들레">민들레
						<input type="checkbox" name="al" value="계란흰자">계란흰자
					</fieldset>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-offset-8 col-md-2">
						<input type="button" class="button" value="회원 가입" onclick="inputCheck()">
					</div>
					<div class="col-md-offset-2"></div>
				</div>
			</form>
