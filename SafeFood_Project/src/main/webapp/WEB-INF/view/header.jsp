...
<script src="https://unpkg.com/vue"></script> <!-- Vue 최신버전 반영 -->
<script src="https://unpkg.com/axios/dist/axios.min.js"></script> <!-- axios -->
<script src="https://unpkg.com/vue-router/dist/vue-router.js"></script> <!-- Vue router 사용 -->
<link href="https://fonts.googleapis.com/css?family=Do+Hyeon|Gugi|Noto+Sans+KR|Gothic+A1|Open+Sans" rel="stylesheet">
<script type="text/javascript">
var trailimage=["img/1169874.gif", 50, 100]  //이미지 경로 설정
var offsetfrommouse=[10,10]  //커서와 이미지의 간격
var displayduration=0 

if (document.getElementById || document.all)
	document.write('<div id="trailimageid" style="position:absolute;visibility:visible;left:0px;top:0px;width:1px;height:1px;z-index:1;"><img src="'+trailimage[0]+'" border="0" width="'+trailimage[1]+'px" height="'+trailimage[2]+'px"></div>')
...
leaf_image[0]='img/메로나.png';
leaf_image[1]='img/비비빅.png';
leaf_image[2]='img/수박바.png';
leaf_image[3]='img/죠스바.png';
...
function autumn_leaves() {
  ...
  if (100>untidy*leaves && !tidying && Math.random()<.05) tidy_leaves();
}
		...
		<nav class="navbar navbar-default navbar-fixed-top navbar-inverse"
			...
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="main.mvc">
					<img src="https://edu.ssafy.com/asset/images/logo.png" height="50px" width="70px">
					</a>
				</div>
				<div class="collapse navbar-collapse navbar-left navbar-ex1-collapse">
					<ul class="nav navbar-nav" id="menu">
						<li><a href="notice-list.mvc">공지 사항</a></li>
						<li><a href="list.mvc">상품 정보</a></li>
						<li><a href="intakeInfo.mvc">내 섭취 정보</a></li>
						<li><a href="foodcart.mvc">예상 섭취 정보</a></li>
						<li><a href="qna-list.mvc">고객 문의</a></li>
					</ul>
				</div>
				<div
					...
					<ul class="nav navbar-nav" id="menuMember">
						...
						<li>
							<div class="dropdown">
							  <button id="mail_icon" class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
							  			style="border: none; background-color: transparent;">
							  			<template v-if="isNew()">
							    			<img alt="yes_mail" src="img/nom.png" height="40px" width="30px" style="padding-top: 15px;">
							    		</template>
							    		<template v-else="isNew()">
							    			<img alt="no_mail" src="img/nom3.png" height="40px" width="30px" style="padding-top: 15px;">
							    		</template>
							  </button>
							  <div class="dropdown-menu dropdown-menu-left p-4 text-muted">
								  <div class="mailbox" aria-labelledby="dropdownMenuButton" style="width: 500px; padding: 10px;" >
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	      <div class="item active">
	        <img src="img/계란스-1.jpg" alt="watermelon" style="width:100%;">
	      </div>
	    
	      <div class="item">
	        <img src="img/아몬드베리블랙베리.jpg" alt="almond" style="width:100%;">
	      </div>
	      
	      <div class="item">
	        <img src="img/팬케이크.jpg" alt="cake" style="width:100%;">
	      </div>
	      
	      <div class="item">
	        <img src="img/감자사망-1.jpg" alt="potato" style="width:100%;">
	      </div>
	    </div>
